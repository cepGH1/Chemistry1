/* 
 * Object oriented pairs game, using cepCard objects
 * 
 * .
 */

/*
 * the cepCard prototype
 */
...
var cards = [];
var backImage = "../../images/organicPairs/back1.jpg";
var backImage2 = "../../images/organicPairs/back2.jpg";
var cardCount = 0;
var exposedCard1;
var exposedCard2;
var exposedCell1;
...
function dealCepCards(){
    ...
    for (i = 0; i < size; i++) {
        ...
        var front = "../../images/organicPairs/"+i+".png";
        var name = "complex ion";
        var value = i;
        var exposed = false;
        
    cards[i] = new cepCard(backImage2, front, name, value, exposed);
}
    for (i=0; i< size; i++){
